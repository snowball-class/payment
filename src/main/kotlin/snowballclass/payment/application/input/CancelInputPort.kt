...
class CancelInputPort(
    ...
    override fun cancel(orderId: UUID, cancelPaymentInputDto:CancelPaymentInputDto):Boolean {
        ...
        val tossClient: TossService = TossClient().create()
        ...
        try {
            val response:ResponseEntity<TossResponse> = tossClient.cancel(paymentKey = payment.paymentKey, secretKey = secretKey, contentType = "application/json", body = data)
